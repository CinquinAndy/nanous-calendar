	...
	return (
		<main className="mx-auto w-full max-w-2xl flex-1 space-y-10 px-4 pt-8 pb-24 sm:pt-12">
			...
			<Section title="Objet du site">
				<p>
					Nanou&apos;s Calendar est un outil <strong>gratuit</strong> d&apos;aide à l&apos;organisation des rendez-vous
					entre enseignant·es et familles : les enseignant·es publient leurs créneaux de disponibilité, les familles
					réservent un horaire et reçoivent une confirmation par email.
				</p>
				<p>
			...
			<Section title="Données personnelles">
				...
				<p>
					Ces données sont utilisées <strong>uniquement</strong> pour le fonctionnement du site (affichage des créneaux,
					envoi des emails de confirmation, gestion des réservations). Elles ne sont <strong>jamais</strong> vendues,
					louées, cédées ni utilisées à des fins publicitaires ou de profilage.
				</p>
